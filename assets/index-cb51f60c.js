(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))n(e);new MutationObserver(e=>{for(const o of e)if(o.type==="childList")for(const s of o.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&n(s)}).observe(document,{childList:!0,subtree:!0});function a(e){const o={};return e.integrity&&(o.integrity=e.integrity),e.referrerPolicy&&(o.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?o.credentials="include":e.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function n(e){if(e.ep)return;e.ep=!0;const o=a(e);fetch(e.href,o)}})();const Y=document.querySelector(".primary-header"),l=document.querySelector(".mobile-nav-toggle"),i=document.querySelector(".primary-nav");l.addEventListener("click",()=>{i.hasAttribute("data-visible")?l.setAttribute("aria-expanded","false"):l.setAttribute("aria-expanded","true"),i.hasAttribute("data-visible")?document.body.style.overflowY="visible":document.body.style.overflowY="hidden",i.hasAttribute("data-visible")?document.body.style.touchAction="auto":document.body.style.touchAction="none",i.toggleAttribute("data-visible"),Y.toggleAttribute("data-overlay")});const p=()=>{document.body.style.setProperty("--vw",(self.innerWidth/100).toString()),document.body.style.setProperty("--vh",(self.innerHeight/100).toString())};p();window.addEventListener("resize",p);const w=Array.from(document.querySelectorAll(".glitch"));w.forEach(t=>{const r=Math.random()*2e3;t.style.setProperty("--glitch-anim-delay",`${-r}ms`);const a=Math.random()<.5?"alternate":"alternate-reverse";t.style.setProperty("--glitch-anim-dir",a);const n=Math.random()*1.5+1.5;t.style.setProperty("--glitch-anim-duration",`${n}s`),t.style.setProperty("--glitch-content",`'${t.textContent}'`)});const A=Array.from(document.querySelectorAll(".glitch-delay"));A.forEach(t=>{t.style.setProperty("--glitch-content",`'${t.textContent}'`)});const x=.25,y=.25,E=document.getElementById("bg-container"),b=document.querySelector(".scrolling-background");var P=document.documentElement.innerHTML,Z=P.replace(/ style="[^"]*"/g,""),f=document.createElement("pre");f.textContent=Z;b.appendChild(f);const S=document.querySelector(".scrolling-background").innerHTML,g=b.offsetHeight,m=window.innerHeight,u=Math.ceil(m/g),C=(u-m/g)*100,d=m/g*100+C,H=d+100,c=100/H*100,v=50/x,h=document.createElement("style");h.textContent=`
  :root {
    --bg-rotateX: 2deg;
    --bg-rotateY: -3deg;
    --bg-rotateZ: 5deg;
...
`;document.head.appendChild(h);const L=1/(u+1);for(let t=0;t<u;t++){const r=document.createElement("div");r.classList.add("scrolling-background"),r.innerHTML=S;const a=v*L*(t+1);r.style.animationDelay="-"+a+"s",E.appendChild(r)}document.addEventListener("mousemove",t=>{Array.from(document.getElementsByClassName("scrolling-background")).forEach(a=>{M(t,a)})});function M(t,r){const a=t.clientX,n=t.clientY,e=window.innerWidth/2,o=window.innerHeight/2,s=(n-o)/o*y,X=(a-e)/e*y;r.style.setProperty("--bg-rotateX",-1*s+2+"deg"),r.style.setProperty("--bg-rotateY",X-3+"deg")}
